...
```bash
gh api user/starred/INNERJOINT/oh-my-claudecode &>/dev/null
```
...
```bash
gh api -X PUT /user/starred/INNERJOINT/oh-my-claudecode 2>/dev/null && echo "Thanks for starring!" || true
```
...
echo "  https://github.com/INNERJOINT/oh-my-claudecode"
echo ""
```
