...
```
WebFetch(url: "https://raw.githubusercontent.com/INNERJOINT/oh-my-claudecode/main/docs/CLAUDE.md", prompt: "Return the complete raw markdown content exactly as-is")
```
